            ...
            void (async () => {
                ...
                try {
                    if (options.includeFiles) {
                        files = await (0, util_1.promisify)(this.makeAllFilesPublicPrivate_).call(this, options);
                    }
                }
                catch (callErr) {
                    callback(callErr);
    ...
    makePublic(optionsOrCallback, callback) {
        ...
        void (async () => {
            ...
            try {
                ...
                if (req.includeFiles) {
                    files = await (0, util_1.promisify)(this.makeAllFilesPublicPrivate_).call(this, req);
                }
            }
            catch (err) {
                callback(err);
