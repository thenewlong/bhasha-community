...
export default function AdminDashboard() {
  ...
  // 1. Fetch Words Data from Backend API for Admin
  ...
  const handleApprove = async (id) => {
    if (!window.confirm("Are you sure you want to approve this word?")) return;
    try {
  ...
  // 3. Admin Reject Action
  const handleReject = async (id) => {
    if (!window.confirm("Are you sure you want to reject this word?")) return;
    try {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete this word permanently?")) return;
    try {
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: "11px", color: "#2563EB", fontWeight: "600" }}>Administrator</div>
            </div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                  <thead>
                    <tr style={{ backgroundColor: "#F8FAFC", borderBottom: "1px solid #E2E8F0" }}>
                      ...
                      <th style={{ padding: "12px 16px", fontSize: "13px", fontWeight: "600", color: "#475569", textAlign: "center", width: "180px" }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
